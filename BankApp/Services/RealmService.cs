        ...
        public static Realm GetRealm()
        {
            var config = new FlexibleSyncConfiguration(app.CurrentUser)
            {
                PopulateInitialSubscriptions = (realm) =>
                {
                    ...
                    realm.Subscriptions.Add(realm.All<Transfer>().Where(i => i.OwnerId == CurrentUser.Id));
                    realm.Subscriptions.Add(realm.All<Payment>().Where(i => i.OwnerId == CurrentUser.Id));
                    realm.Subscriptions.Add(realm.All<DebitPayment>().Where(i => i.OwnerId == CurrentUser.Id));
                }
            };
